...
public class UploadOnDrive extends AppCompatActivity implements GoogleApiClient.ConnectionCallbacks,
                    ...
                    new Thread() {
                        ...
                        public void run() {
                            ...
                            MetadataChangeSet changeSet = new MetadataChangeSet.Builder()
                                    .setTitle("SurveyBackup")
                                    .setMimeType("text/plain")
                                    .setDescription("The file contains the backup of all the answers")
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_upload_on_drive);
        ...
        String fileName = "SurveyAnsList.txt";
